...
import exception.CodigoNaoExiste;
                ...
                case 1:
                    ...
                    switch (escolhaEquipamento) {
                        ...
                        case 2:
                            ...
                            throw new CodigoNaoExiste("O código não existe na base de dados!");
                        }
                    }catch(CodigoNaoExiste erro){
                        System.out.println("Erro - " + erro.getMessage());
                    }
                        ...
                        case 3:
                            ...
                            if(listaEquipamentos.stream().anyMatch(e -> e.getCodigo() == codigoAlterar) == false){
                                System.out.println("O código não existe na base de dados!");
                            }
