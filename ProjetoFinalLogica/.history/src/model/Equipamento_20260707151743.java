...
public  class Equipamento {
    ...
    public void setCodigo(int codigo, ArrayList<Equipamento> listaEquipamentos) {
    ...
    public Equipamento(int codigo, String nome, String categoria, String fabricante, String modelo,
            String setorInstalado, String dataInstalacao, String status, ArrayList<Equipamento> listaEquipamentos) throws SituacaoInvalidaException, CodigoDuplicadoException{
