...
public class Manutencao {
    ...
    public Manutencao(int codigo, int codigoEquipamentoRelacionado, int codigoTecnicoRelacionado, String dataAbertura,
            String dataEncerramento, String tipoManutencao, String descricaoProblema, String situacao, ArrayList<Manutencao> listaManutencaos, ArrayList) throws SituacaoInvalidaException,CodigoDuplicadoException {
