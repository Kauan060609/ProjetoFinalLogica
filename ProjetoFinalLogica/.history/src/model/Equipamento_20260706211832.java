...
public  class Equipamento {
    ...
    public void setStatus(String status) throws new SituacaoInvalidaException{
        if(status.equals("Aberta") == false && status.equals("Em andamento") == false && status.equals("Finalizada") ==  false){
