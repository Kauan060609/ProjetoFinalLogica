...
public  class Equipamento {
    ...
    public  void mostrarEquipamento() {
        ...
        System.out.println("Data Instalação - " + this.status);
    }
    ...
    public Equipamento(int codigo, String nome, String categoria, String fabricante, String modelo,
            String setorInstalado, String dataInstalacao, String status) throws CodigoDuplicladoException{
                if(nome.equals(categoria){
                    throw new CodigoDuplicladoException("aaa");
                })
        this.codigo = codigo;
        this.nome = nome;
        this.categoria = categoria;
