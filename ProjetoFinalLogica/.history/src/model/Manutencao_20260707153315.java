...
public class Manutencao {
    ...
    public Manutencao(int codigo, int codigoEquipamentoRelacionado, int codigoTecnicoRelacionado, String dataAbertura,
            String dataEncerramento, String tipoManutencao, String descricaoProblema, String situacao, ArrayList<Manutencao> listaManutencaos, ArrayList<Equipamento> listaEquipamentos, ArrayList<Tecnico> listeTecnicos) throws SituacaoInvalidaException,CodigoDuplicadoException, CodigoNaoExisteException {
