...
public class Tecnico {
     ...
     private int[] manutencoesResponsaveis;
     ...
     public int[] getManutencoesResponsaveis() {
         return manutencoesResponsaveis;
     }

     public void setManutencoesResponsaveis(int[] manutencoesResponsaveis) {
         this.manutencoesResponsaveis = manutencoesResponsaveis;
     }
