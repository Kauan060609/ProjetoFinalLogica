                        ...
                        try{
                            ...
                            for(Tecnico t : listaTecnicos){
                                if(t.getCodigo() == codigoAlterar){
                                    t.setNome(nome);
                                    t.setMatricula(matricula, listaTecnicos);
                                    t.setSetor(setor);
                        ...
                        try{
                            ...
                            for(Tecnico t : listaTecnicos){
                                    if(t.getCodigo() == codigoRemover){
                                        if(t.isResponsavel()){
                                            throw new ManutencaoAbertaException("O Técnico não pode ser excluido enquanto está em manutenção!");
                                        }
                                    }
                                }
                            ...
                            if(situacao.equals("Finalizada")){
                                ...
                                for(Manutencao mm : listaManutencaos){
                                    if(mm.getCodigo() == codigoAlterar){
                                        mm.setDataEncerramento(LocalDate.no));
                                         }
                                }
                ...
                case 4:
                    ...
                    switch (escolhaRelatorio) {
                        ...
                        case 2:
                            ...
                            System.out.println("Em andamento - " + quantEmAndamento);
                            break;
                        ...
                        case 3:
                            ...
                            System.out.println("Manutenções Abertas - " + quantAbertas);
                            System.out.println("Manutenções Finalizadas - " + quantFinal);
                            break;
